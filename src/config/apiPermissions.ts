...
export const APP_FEATURES: AppFeatureDef[] = [
  { id: 'knowledge-manage', label: '지식 관리', description: '지식 RAG 등록 및 수정', category: 'knowledge', icon: BookOpen, requiredFeatureKeys: ['KNOWLEDGE_REGISTER', 'KNOWLEDGE_UPDATE', 'KNOWLEDGE_DELETE', 'KNOWLEDGE_PURGE'] },
...
export const API_PERMISSIONS: ApiPermissionDef[] = [
  ...
  { featureKey: 'KNOWLEDGE_PURGE', method: 'POST', pathPrefix: '/api/knowledge/purge', label: '지식 초기화', description: '지식 전체 초기화(삭제)', category: 'knowledge', icon: TrashIcon },
