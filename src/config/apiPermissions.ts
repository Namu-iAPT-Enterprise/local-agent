...
import {
  ...
  UserCog, PenLine, UserMinus, Users2, Eye,
...
export const API_PERMISSIONS: ApiPermissionDef[] = [
  ...
  { featureKey: 'FILE_DELETE_ANY', method: 'DELETE', pathPrefix: '/api/files/', label: '타인 파일 삭제', description: '타인이 업로드한 파일 삭제', category: 'file', icon: TrashIcon },
  ...
  { featureKey: 'NOTICE_UPDATE', method: 'POST', pathPrefix: '/api/notice/update', label: '공지 수정', description: '기존 공지 내용 수정', category: 'notice', icon: PenLine },
  ...
  { featureKey: 'NOTICE_UPDATE_ALL', method: 'POST', pathPrefix: '/api/notice/all/update', label: '전체 공지 수정', description: '전체 공지 내용 수정', category: 'notice', icon: PenLine },
  ...
  // Team
  { featureKey: 'TEAM_CREATE', method: 'POST', pathPrefix: '/api/management/team', label: '팀 생성', description: '신규 팀 생성', category: 'admin', icon: Users2 },
  ...
  // Cache & System
  { featureKey: 'CACHE_RELOAD_USER', method: 'POST', pathPrefix: '/api/management/role/reload', label: '사용자 캐시 새로고침', description: '특정 사용자의 역할 캐시 무효화', category: 'admin', icon: RefreshCw },
  { featureKey: 'CACHE_RELOAD_ALL', method: 'POST', pathPrefix: '/api/management/role/reload/all', label: '전체 캐시 새로고침', description: '전체 역할 캐시 무효화', category: 'admin', icon: RefreshCw },
  ...
  { featureKey: 'BACKUP_RESTORE', method: 'POST', pathPrefix: '/api/management/backups/', label: '백업 복구', description: '특정 백업본 복구 요청', category: 'admin', icon: RotateCcw },
  ...
  // Account
  { featureKey: 'ACCOUNT_ROLE_VIEW', method: 'GET', pathPrefix: '/api/management/account/role', label: '계정 역할 조회', description: '사용자 계정의 역할(USER/ADMIN) 조회', category: 'admin', icon: UserCog },
  { featureKey: 'ACCOUNT_ROLE_CHANGE', method: 'PATCH', pathPrefix: '/api/management/account/role', label: '계정 역할 변경', description: 'USER ↔ ADMIN 계정 역할 변경', category: 'admin', icon: UserCog },
  ...
  { featureKey: 'REQUEST_VIEW', method: 'GET', pathPrefix: '/api/management/request/', label: '문의사항 상세', description: '문의사항 상세 내용 조회', category: 'request', icon: FileText },
